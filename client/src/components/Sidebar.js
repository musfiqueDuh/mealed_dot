...
import { ReactComponent as CustomLogo } from "./images/DOT.svg";
    ...
    <div className="sidebar">
      <ul className="sidebar-menu">
        ...
        <li className="sidebar-menu-items tweet-list-item">
          <Popup
            trigger={
              <button className="tweetBtn sidebar-menu-tweetBtn">Dot Now</button>
            }
            modal
            position="center"
          >
            {(close) => (
              ...
              >
                <input
                  autoFocus
                  placeholder="Meals, Fitness and Plans, What's on your Mind?"
                  type="text"
                  value={input}
